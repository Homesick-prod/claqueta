                ...
                <Link
                  ...
                  className={`
                    ...
                    ${isActive(group.href) 
                      ...
                      : 'hover:bg-[var(--neutral-700)]/20 text-[var(--text)]'}
                  `}
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className={`
                    ...
                    ${hasActiveChild 
                      ? 'bg-[var(--brand)]/10 text-[var(--brand)]' 
                      : 'text-[var(--muted)] hover:text-[var(--text)] hover:bg-[var(--neutral-700)]/20'}
                  `}
                  ...
                  {group.children.map((item) => {
                    ...
                    return (
                      <div key={item.href} className="relative">
                        {isActive(item.href) && (
                          <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-6 bg-[var(--accent)] rounded-r-sm transition-all duration-500 ease-out" />
                        )}
                        <Link
                          href={item.href}
                          className={`
                            ...
                            ${isActive(item.href)
                              ...
                              : 'hover:bg-[var(--neutral-700)]/20 text-[var(--muted)] hover:text-[var(--text)]'}
                          `}
                        >
                          <div className="absolute inset-0 bg-gradient-to-r from-transparent to-transparent group-hover:from-[var(--accent)]/5 group-hover:to-transparent transition-all duration-500" />
                          <ItemIcon className={`relative w-4 h-4 shrink-0 ${isActive(item.href) ? 'text-[var(--accent)]' : ''}`} />
